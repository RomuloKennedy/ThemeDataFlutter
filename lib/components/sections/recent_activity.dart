...
// ele começa com _ para dizer que é uma classe privada
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Container(
          clipBehavior: Clip.hardEdge, // para poder funcionar o border radius no lienarProgress, que está ultrapassando o limite do container
